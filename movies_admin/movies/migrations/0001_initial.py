    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie_people', models.ManyToManyField(through='movies.MoviePeople', to='movies.Movies')),
            ],
            options={
                'verbose_name': 'person',
        ...
        migrations.AddField(
            model_name='moviepeople',
            name='person',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.people'),
        ),
        migrations.AddField(
